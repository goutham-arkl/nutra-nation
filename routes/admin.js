...
router.get('/add-category', (req,res) => {
  let err=req.session.exist
 
  res.render('addcategory',{err:err})
})

router.post('/submit-category',(req,res) => {
let a=req.body.name+''
let b= a.toUpperCase()

  producthelper.addcategory(b, (id) => {
...
router.post('/add-banner', (req, res) => {
  adminHelper.addBanner(req.body, (id) => {
    let images = req.files.banner;


    images.mv('./public/images/banner/' + id + '.jpg', (err, data) => {
      if (!err) {
